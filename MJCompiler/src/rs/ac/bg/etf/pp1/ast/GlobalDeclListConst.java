...
public class GlobalDeclListConst extends GlobalDeclList {

    private GlobalDeclList GlobalDeclList;
    private ConstDecl ConstDecl;

    public GlobalDeclListConst (GlobalDeclList GlobalDeclList, ConstDecl ConstDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalDeclListConst(\n");
