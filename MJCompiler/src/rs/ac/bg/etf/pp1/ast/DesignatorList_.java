...
public class DesignatorList_ extends DesignatorList {

    private DesignatorList DesignatorList;
    private OptionalDesignator OptionalDesignator;

    public DesignatorList_ (DesignatorList DesignatorList, OptionalDesignator OptionalDesignator) {
