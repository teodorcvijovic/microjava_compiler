...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(A_Minus A_Minus) { visit(); }
    public void visit(A_Plus A_Plus) { visit(); }
    public void visit(R_Le R_Le) { visit(); }
    public void visit(R_Lt R_Lt) { visit(); }
    public void visit(R_Ge R_Ge) { visit(); }
    public void visit(R_Gt R_Gt) { visit(); }
    public void visit(R_Ne R_Ne) { visit(); }
    public void visit(R_Deq R_Deq) { visit(); }
    public void visit(Assignop Assignop) { visit(); }
    public void visit(Label Label) { visit(); }
    public void visit(EmptyIdentExprList EmptyIdentExprList) { visit(); }
    ...
    public void visit(ParenWithOptionalActPars ParenWithOptionalActPars) { visit(); }
    ...
    public void visit(OptionalActParsParen_ OptionalActParsParen_) { visit(); }
    public void visit(F_Expr F_Expr) { visit(); }
    public void visit(F_TypeExprActPars F_TypeExprActPars) { visit(); }
    public void visit(F_BoolConst F_BoolConst) { visit(); }
    public void visit(F_CharConst F_CharConst) { visit(); }
    public void visit(F_NumConst F_NumConst) { visit(); }
    public void visit(F_DesignatorActPars F_DesignatorActPars) { visit(); }
    public void visit(EmptyMulopFactorList EmptyMulopFactorList) { visit(); }
    public void visit(MulopFactorList_ MulopFactorList_) { visit(); }
    public void visit(Term Term) { visit(); }
    public void visit(EmptyAddopTermList EmptyAddopTermList) { visit(); }
    public void visit(AddopTermList_ AddopTermList_) { visit(); }
    public void visit(NoMinus NoMinus) { visit(); }
    public void visit(OptionalMinus_ OptionalMinus_) { visit(); }
    public void visit(Expr Expr) { visit(); }
    public void visit(NoOptionalRelopExpr NoOptionalRelopExpr) { visit(); }
    public void visit(OptionalRelopExpr_ OptionalRelopExpr_) { visit(); }
    ...
    public void visit(DesignatorList_ DesignatorList_) { visit(); }
    public void visit(NoOptionalDesignator NoOptionalDesignator) { visit(); }
    public void visit(OptionalDesignator_ OptionalDesignator_) { visit(); }
    ...
    public void visit(Option_Dec Option_Dec) { visit(); }
    public void visit(Option_Inc Option_Inc) { visit(); }
    public void visit(Option_ActPars Option_ActPars) { visit(); }
    public void visit(Option_Assign Option_Assign) { visit(); }
    public void visit(ERROR_DesignatorStatement ERROR_DesignatorStatement) { visit(); }
    public void visit(DesignatorWithSquare DesignatorWithSquare) { visit(); }
    public void visit(DesignatorWithOptions DesignatorWithOptions) { visit(); }
    ...
    public void visit(ReturnOptionalExpr_ ReturnOptionalExpr_) { visit(); }
    ...
    public void visit(M_Read M_Read) { visit(); }
    public void visit(M_Return M_Return) { visit(); }
    public void visit(M_Continue M_Continue) { visit(); }
    public void visit(M_Break M_Break) { visit(); }
    public void visit(M_While M_While) { visit(); }
    public void visit(M_IfElse M_IfElse) { visit(); }
    public void visit(M_Designator M_Designator) { visit(); }
    public void visit(U_IfElse U_IfElse) { visit(); }
    public void visit(U_If U_If) { visit(); }
    public void visit(Unmatched_ Unmatched_) { visit(); }
    public void visit(Matched_ Matched_) { visit(); }
    public void visit(Type Type) { visit(); }
    public void visit(EmptyTypeIdentList EmptyTypeIdentList) { visit(); }
    public void visit(TypeIdentList_ TypeIdentList_) { visit(); }
    public void visit(ERROR_OneFormPar ERROR_OneFormPar) { visit(); }
    public void visit(OneFormPar_ OneFormPar_) { visit(); }
    ...
    public void visit(EmptyClassVarDeclList EmptyClassVarDeclList) { visit(); }
    public void visit(VarDeclList_ VarDeclList_) { visit(); }
    public void visit(ConstructorDecl ConstructorDecl) { visit(); }
    public void visit(MethodDecl_Ident MethodDecl_Ident) { visit(); }
    public void visit(MethodDecl_Void MethodDecl_Void) { visit(); }
    public void visit(NoConstructorDeclList NoConstructorDeclList) { visit(); }
    public void visit(ConstructorDeclList_ ConstructorDeclList_) { visit(); }
    public void visit(OneMethodDecl OneMethodDecl) { visit(); }
    public void visit(MethodDeclList_Void MethodDeclList_Void) { visit(); }
    public void visit(MethodDeclList_Ident MethodDeclList_Ident) { visit(); }
    public void visit(ConstructorDecl_Start ConstructorDecl_Start) { visit(); }
    public void visit(EmptyClassMethodConstructorLists EmptyClassMethodConstructorLists) { visit(); }
    public void visit(Methods_Void Methods_Void) { visit(); }
    public void visit(Methods_Ident Methods_Ident) { visit(); }
    public void visit(Constructors Constructors) { visit(); }
    public void visit(ConstructorsAndMethods_Void ConstructorsAndMethods_Void) { visit(); }
    public void visit(ConstructorsAndMethods_Ident ConstructorsAndMethods_Ident) { visit(); }
    public void visit(EmptyConstructorMethodLists EmptyConstructorMethodLists) { visit(); }
    public void visit(ConstructorMethodLists_ ConstructorMethodLists_) { visit(); }
    public void visit(ClassDerivation ClassDerivation) { visit(); }
    public void visit(NoDerivation NoDerivation) { visit(); }
    public void visit(OptionalDerivation_ OptionalDerivation_) { visit(); }
    public void visit(Class_EmptyVarDeclList Class_EmptyVarDeclList) { visit(); }
    ...
    public void visit(Class_NewVarDecl Class_NewVarDecl) { visit(); }
    public void visit(ERROR_Class_VarDecl ERROR_Class_VarDecl) { visit(); }
    ...
    public void visit(OtherConstDeclarations_ OtherConstDeclarations_) { visit(); }
    ...
    public void visit(GlobalMethodDecl_Ident GlobalMethodDecl_Ident) { visit(); }
    public void visit(GlobalMethodDecl_Void GlobalMethodDecl_Void) { visit(); }
    ...
    public void visit(EmptyGlobalDeclList EmptyGlobalDeclList) { visit(); }
    public void visit(GlobalDeclListClass GlobalDeclListClass) { visit(); }
    public void visit(GlobalDeclListVar GlobalDeclListVar) { visit(); }
    public void visit(GlobalDeclListConst GlobalDeclListConst) { visit(); }
